...
class History extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['ins_ts'], 'safe'],
            [['customer_id', 'event_id', 'object_id', 'user_id'], 'integer'],
            [['event_id'], 'required'],
            [['message', 'detail'], 'string'],
            [['object'], 'string', 'max' => 255],
            [['event_id'], 'exist', 'skipOnError' => true, 'targetClass' => HistoryEvent::class, 'targetAttribute' => ['event_id' => 'id']],
    ...
    {
        return $this->hasOne(HistoryEvent::class, ['id' => 'event_id']);
    }
    ...
    {
        return HistoryEvent::getEventTextByEventId($this->event_id);
    }
